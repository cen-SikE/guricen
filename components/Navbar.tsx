...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: '진료예약', href: '#appointment' },
    { name: '병원통계', href: '#stats' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0 flex items-center">
            <span className="text-2xl font-bold text-blue-700 tracking-tight">구리 <span className="text-blue-900">센트럴병원</span></span>
          </div>
